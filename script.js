const SECTIONS = {
  about: `
    ...
    <div class="about-hero">
      <div class="about-photo"><img src="assets/profilepic.jpeg" alt="michelle mah" /></div>
  ...
  projects: `
    ...
    <div class="proj-list">
      <div class="proj-card">
        ...
        <a class="proj-link" href="https://github.com/michelleamah/bookmate" target="_blank" rel="noopener">view on github →</a>
      </div>
      <div class="proj-card">
        <h3>website</h3>
        ...
        <a class="proj-link" href="https://github.com/michelleamah/website" target="_blank" rel="noopener">view on github →</a>
      </div>
      <div class="proj-card">
        <h3>bandsite</h3>
        <div class="lang-chips"><span class="chip">HTML</span><span class="chip">CSS</span><span class="chip">JavaScript</span></div>
        <p>A responsive promotional site for a fictional band, pulling live show data from an external API.</p>
        <a class="proj-link" href="https://github.com/michelleamah/bandsite" target="_blank" rel="noopener">view on github →</a>
      </div>
    </div>`,
